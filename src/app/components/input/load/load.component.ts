...
export class LoadComponent implements OnInit {
  ...
  private columnHeaders =[
    { title: "始点X", dataType: "float",  format: "#.000", dataIndx: "x_s",  sortable: false, width: 90 },
    { title: "終点X", dataType: "float",  format: "#.000", dataIndx: "x_d",  sortable: false, width: 90 },
    { title: "荷重量", dataType: "float",  format: "#.000", dataIndx: "loadAmount",  sortable: false, width: 90 },
  ];
